		...
		<div class="width100">
			<div class="cus_find_id_pass">
				<div class="nav nav-tabs tab-modern">
					<a class="nav-link tab-modern__nav-link active" href="javascript:void(0);">ID 찾기</a>
					<a class="nav-link tab-modern__nav-link" href="/user/find_pw">비밀번호 찾기</a>
				</div>
				<div class="pt-4 pt-md-8">
					<form id="findIdForm" method="post" action="/user/find_id_ok">
...
<!-- 								<span class="certification-number text-success" id="countdown">&nbsp;</span> -->
<!-- 								<button class="btn btn-md btn-dark btn-zip rounded-8 disabled" id="btn_validate_code_check" type="button">인증</button> -->
<!-- 								<input class="form-control form-control-sm form__input form-control-grey" id="input_certification" type="text" name="validate_mobile" value="" placeholder="인증번호" maxlength="4" autocomplete="off"> -->
<!-- 								<div class="invalid-feedback text-success" id="error_validate_mobile" style="display:block;">&nbsp;</div> -->
<!-- 							</div> -->
							
							
							<button class="btn weight300 btn-dark btn-xl btn-block find_id" type="button">확인</button>
						</section>
					</form>
				</div>
